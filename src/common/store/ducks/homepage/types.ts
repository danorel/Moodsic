...
export type FetchHomepageSuccessAction = ReduxAction<typeof FETCH_HOMEPAGE_SUCCESS, {}>;
export type FetchHomepageFailureAction = ReduxAction<typeof FETCH_HOMEPAGE_FAILURE, string>;

export type HomepageActionTypes = FetchHomepageAction | FetchHomepageSuccessAction | FetchHomepageFailureAction;
