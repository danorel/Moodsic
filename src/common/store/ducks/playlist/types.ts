...
export type FetchPlaylistSuccessAction = ReduxAction<typeof FETCH_PLAYLIST_SUCCESS, Playlist>;
export type FetchPlaylistFailureAction = ReduxAction<typeof FETCH_PLAYLIST_FAILURE, string>;

export type PlaylistActionTypes = FetchPlaylistRequestAction | FetchPlaylistSuccessAction | FetchPlaylistFailureAction;
