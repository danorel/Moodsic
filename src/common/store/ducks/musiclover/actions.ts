...
export function fetchMusicloverSuccess(data: Musiclover): types.FetchMusicloverSuccessAction {
    return { type: types.FETCH_MUSICLOVER_SUCCESS, payload: data };
}

export function fetchMusicloverError(error: string): types.FetchMusicloverFailureAction {
