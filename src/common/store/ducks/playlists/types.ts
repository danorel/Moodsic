...
export type FetchPlaylistsSuccessAction = ReduxAction<typeof FETCH_PLAYLISTS_SUCCESS, Playlist[]>;
export type FetchPlaylistsFailureAction = ReduxAction<typeof FETCH_PLAYLISTS_FAILURE, string>;
...
export type FetchPlaylistsByQuerySuccessAction = ReduxAction<typeof FETCH_PLAYLISTS_BY_QUERY_SUCCESS, Playlist[]>;
export type FetchPlaylistsByQueryFailureAction = ReduxAction<typeof FETCH_PLAYLISTS_BY_QUERY_FAILURE, string>;
