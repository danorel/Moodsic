...
} from 'common/store/ducks/shoes/selectors';
import { getHomepage } from 'common/store/ducks/homepage/selectors';
import { fetchShoes as fetchShoesActionCreator } from 'common/store/ducks/shoes/actions';
import { fetchHomepage as fetchHomepageActionCreator } from 'common/store/ducks/homepage/actions';
