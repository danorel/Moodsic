...
import { State, Sneakers } from 'common/types';
import { fetchCatalog } from 'common/store/ducks/catalog/actions';
import { getCatalog, isLoading } from 'common/store/ducks/catalog/selectors';
import { SneakersList, PageMeta, PageContainer, Page } from 'client/components';
